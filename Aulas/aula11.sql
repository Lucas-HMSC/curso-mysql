...
/*Refinando buscas com o SELECT*/

SELECT * FROM cursos
ORDER BY nome; /*DESC para ordenação inversa*/

SELECT ano, nome, carga FROM cursos /*Escolhendo quais colunas buscar*/
ORDER BY ano, nome; /*Ordenando primeiro pelo ano, depois pelo nome*/

SELECT nome, carga FROM cursos /*Buscando apenas os cursos de 2016*/
WHERE ano = '2016' 
ORDER BY nome;

SELECT nome, descricao FROM cursos /*Buscando os cursos até 2015*/
WHERE ano <= 2015
ORDER BY nome;

SELECT nome, ano FROM cursos /*Buscando cursos entre os anos 2014 e 2016*/
WHERE ano BETWEEN 2014 AND 2016
ORDER BY ano DESC, nome;

SELECT nome, descricao, ano FROM cursos /*Buscando cursos que sejam dos anos entre ()*/
WHERE ano IN (2014, 2016, 2020)
ORDER BY ano;

SELECT nome, carga, totaulas FROM cursos /*Buscando cursos que satisfaçam a expressão lógica*/
